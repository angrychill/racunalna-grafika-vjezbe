...
//@ts-ignore
static prevediShader(gl, id, tipShadera) {
...
//@ts-ignore
static pripremiGPUprogram(gl, vsID, fsID) {
  var vshader = WebGLPomocnici.prevediShader(gl, vsID, gl.VERTEX_SHADER);
  var fshader = WebGLPomocnici.prevediShader(gl, fsID, gl.FRAGMENT_SHADER);
