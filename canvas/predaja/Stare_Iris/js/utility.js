...
class Utility {
    ...
    static dodajSlider(target, controls, containerId) {
    ...
    static dodajCheckbox(target, key, label, initial = false, containerId) {
        const container = containerId ? document.getElementById(containerId) : document.body;
        const row = document.createElement("div");
        const input = document.createElement("input");
        input.type = "checkbox";
    ...
    static dodajRadio(target, key, labelText, options, containerId) {
        const container = containerId ? document.getElementById(containerId) : document.body;
        ...
        options.forEach(opt => {
            ...
            radio.onchange = () => { if (radio.checked)
                target[key] = opt.value; };
