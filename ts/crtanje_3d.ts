...
class Crtanje3D {
    ...
    nacrtajStozac(r : number, h:number, n:number){
        // r polumjer baze
        // h visina stozca
    ...
    nacrtajValjak(r:number, h:number, n:number){
        let h1 = 0;
        let h2 = h;
        ...
        nacrtajKuglu(r:number, m:number, n:number){
            // r polumjer
            // m meridijani
            //n paralele
        ...
        nacrtajPolukuglu(r:number, m:number, n:number){
